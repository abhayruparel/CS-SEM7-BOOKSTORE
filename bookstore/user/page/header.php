    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" style="margin-bottom: 0">
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    <li class="dropdown">
                        <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <img src="assets/images/users/hritik.jpg" alt="user-img" width="36" class="img-circle"><b class="hidden-xs"><b><?php echo htmlspecialchars($_SESSION["SESSION_EMAIL"]); ?></b></b> </a>
        ...
        <div class="navbar-default sidebar nicescroll" role="navigation">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                    ...
                    <li class="active">
                        <a href="insert_inquiry.php" class="waves-effect"><b>Insert_inquiry</b></a>
                    </li>
                </ul>
            </div>
            <!-- /.sidebar-collapse -->
